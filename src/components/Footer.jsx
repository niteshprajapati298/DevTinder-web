const Footer = () => {
  return (
<footer className="bg-base-200 text-neutral-content px-4 py-3 md:fixed md:bottom-0 w-full shadow-sm">
<div className="flex flex-col md:flex-row items-center justify-between gap-3 text-sm">
        ...
        <nav className="flex gap-4">
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/nitesh-prajapati-44a626269"
            target="_blank"
          ...
          >
            <svg
              ...
              height="22"
              viewBox="0 0 24 24"
              className="fill-current text-blue-600 hover:text-blue-800 transition"
            >
          ...
          >
            <svg
              ...
              height="22"
              viewBox="0 0 24 24"
              className="fill-current text-red-600 hover:text-red-700 transition"
            >
              ...
              11.626.246 15.23 0 3.897-.266 4.356-2.62 
